...
#[derive(Default)]
pub struct CsdRegister(pub [u32; 4]);
...
impl CsdRegister {
    pub fn set_csd_structure_version(&mut self, version: u8) {
        self.0.set_bits(126..128, version as u32);
    }

    pub fn csd_structure_version(&self) -> u8 {
        self.0.get_bits(126..128) as u8
    }
